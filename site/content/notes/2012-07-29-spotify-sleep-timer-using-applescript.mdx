...
<img src={automaterWalkthroughImg}/>
*   Save as Spotify Sleep
  
<img src={automatorImg} />
*   Restart Spotify
*   Click "Spotify" in the toolbar and go down to "Services" and select "sleepSpotify"  
    <img src={spotifyServicesImg} />
*   Follow prompts
    <img src={spotifyPromptImg} />
*   Go to sleep listening to music

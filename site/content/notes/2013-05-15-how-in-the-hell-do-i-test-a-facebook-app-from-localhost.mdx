...
import localhostErrorNoAuthImg from '../../assets/images/facebook-localhost/localhost-error-noauth.png'
import hidingBeforeImg from '../../assets/images/facebook-localhost/localhost-error.png'
...
<img src={localhostErrorNoAuthImg} />
